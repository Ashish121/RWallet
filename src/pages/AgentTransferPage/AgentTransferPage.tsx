        ...
        <IonPage>
          ...
          <IonContent>
            <div className="agentPage-container">
              <IonText className="agentPage-text-area">
              ...
              <div className='agentPage-wrapper'>
                ...
                <InputText inputType="text" labelText="agent.code" labelType="floating" color="light" labelColor="light"/>
                ...
                <div className="clear-button">
                  <IonGrid className="agentPage-header-grid">
                    <IonRow>
